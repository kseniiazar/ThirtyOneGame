...
namespace ThirtyOne.Models
{
    ...
    public class ComputerPlayer : Player
    {
        ...
        public override void Turn(Game game)
        {
            ...
            {
                LastAction = $"{Name} knocks on the table";
                //Knock
                HasKnocked = true;
            }
            else
            {
                ...
                {
                    LastAction = $"{Name} draws a card from the table";
                    DrawFromTable(game);
                }
                else
                {
                    LastAction = $"{Name} draws a card from the deck";
                    DrawFromDeck(game);
                }
                ...
                LastAction = $"{Name} drops {Hand[index].ToString()}";
                DropCard(game, index);
            }
        }
    }
